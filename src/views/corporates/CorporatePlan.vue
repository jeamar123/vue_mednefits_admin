						...
						<div class="account-list-box employee-accounts-container">
							...
							<div class="columns transaction-box align-items-center">
								...
								<div class="column">
									...
									<button @click="_markUsUnpaid_(global_viewPlanData.employee_plan,0)" v-if="global_viewPlanData.employee_plan.paid" class="btn-primary">Mark us unpaid</button>
								</div>
							</div>
						</div>
						...
						<div v-if="global_viewPlanData.spending_deposits.length > 0" class="account-list-box spending-deposit-accounts-container">
							...
							<div v-for="(list, index) in global_viewPlanData.spending_deposits" :key="list.index" class="columns transaction-box align-items-center">
								...
								<div class="column">
									...
									<button @click="_markUsUnpaid_(list,1)" v-if="list.payment_status" class="btn-primary">Mark as unpaid</button>
								</div>
							</div>
						</div>
						...
						<div v-if="global_viewPlanData.employee_refunds.length > 0" class="account-list-box employee-refunds-container">
							...
							<div v-for="(list, index) in global_viewPlanData.employee_refunds" :key="list.index" class="columns transaction-box align-items-center">
								...
								<div class="column">
									...
									<button @click="_markUsUnpaid_(list,2)" v-if="list.payment_status" class="btn-primary">Mark as unpaid</button>
								</div>
							</div>
						</div>
						...
						<div v-if="global_viewPlanData.plan_extension" class="account-list-box plan-extension-container">
							...
							<div class="columns transaction-box align-items-center">
								...
								<div class="column">
									...
									<button @click="_markUsUnpaid_(global_viewPlanData.plan_extension,3)" v-if="global_viewPlanData.plan_extension.paid" class="btn-primary">Mark us unpaid</button>
								</div>
							</div>
						</div>
					</div>
