<template>
	<div class="plan-renewal-wrapper">
		<div class="renewal-header">
			<h1 class="plan-renewal-title">Spending Account Renewal</h1>
			<div class="spending-account-subtext dp-flex">
				<span class="month-term"><span>12 months</span> term</span>
				<span class="start-end-date">
					<span>01/01/2021</span> - <span >31/12/2021</span> 
				</span>
				<button @click="_editSpendingAccountModal_()" class="btn-edit">Edit</button>
			</div>
		</div>
		<div class="spending-account-renewal spending-renewal-wrapper">
			<div class="dp-flex-ai">
				...
				<div class="sub-details-header dp-flex-ai">
					...
					<div>
						<button class="btn-primary confirm-renewal-btn">Confirm Renewal</button>
					</div>
				</div>
			</div>
		...
		<Modal v-if="global_isShowEditSpendingModal" class="edit-spending-account-modal renewal-modal">
			<div slot="header">
				<div class="dp-flex-ai">
					<h4 class="flex-1">Edit Spending Account Team</h4>
					<img @click="_editSpendingAccountModal_()" :src="'../assets/img/cancel.png'">
				</div>
			</div>
			<div slot="body">
				<div class="spending-account-subtext">
					<span class="month-term"><span class="ng-binding">12 months</span> term</span>
					<span class="start-end-date">
						<span>01/01/2021</span> - <span>31/12/2021</span>
					</span>
				</div>
...
<script>
	import spendingAccountRenewal from '@/components/corporates/plan-renewal/spendingAccountRenewal'
